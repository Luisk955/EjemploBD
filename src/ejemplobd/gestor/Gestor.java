package ejemplobd.gestor;

import ejemplobd.cl.Cliente;
import ejemplobd.cl.MultiCliente;
import java.util.*;
...
public class Gestor {
    ...
    public ArrayList<String> listarClientes() throws Exception {
        ...
        for (Cliente client : (new MultiCliente()).listarClientes()) {
            clientesString.add(client.toString());
        }
